...
settings = {
    ...
    "kick":"งิเตะทมอยยย😂\nŚẾL₣ВΌŦ",
    "bye":"ไปซ่ะละ ลาก่อนน่ะ\nŚẾL₣ВΌŦ",
    "Respontag":"แทคยังงี้ปี้กันดีกว่ามั้ย!",
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย ŚẾL₣ВΌŦ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
╠       ŚẾL₣ВΌŦ
╚══════════════┛""",
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "ŚẾL₣ВΌŦ\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
